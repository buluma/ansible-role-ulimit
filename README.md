# [Ansible role ulimit](#ansible-role-ulimit)

Configure ulimit on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-ulimit/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-ulimit/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-ulimit.svg)](https://github.com/buluma/ansible-role-ulimit/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-ulimit.svg)](https://github.com/buluma/ansible-role-ulimit/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-ulimit.svg)](https://github.com/buluma/ansible-role-ulimit/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/ulimit)](https://galaxy.ansible.com/ui/standalone/roles/buluma/ulimit/documentation)|
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-ulimit/issues).
...
### Get Help
- Report issues: https://github.com/buluma/ansible-role-ulimit/issues/new
- See docs: https://docs.ansible.com/collection/gallery/ansible-role-ulimit
